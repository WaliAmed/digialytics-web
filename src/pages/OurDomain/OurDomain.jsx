          ...
          <Col lg={8} sm={12}>
            ...
            <div className="mb-3 domain-desc" style={{ paddingRight: "20pt" }}>
              <p className="font-300">
                ...
                Based on past and current data, our different CV tech-based
                models are implemented to predict the future. This helps ample
                in risk assessment and better decision making. Values of
                different factors can be predicted, which will ultimately play
                significant roles in optimizing your business strategies and
                costs, and thus, fruitful outcomes. So, by building relative
                models and providing solutions, we help investors to make smart
                data driven decisions. Predictions like these usually are:
              </p>
            </div>
            <div>
          ...
          <Col lg={8} sm={12}>
            ...
            <div className="mb-3 domain-desc" style={{ paddingRight: "20pt" }}>
              <p className="font-300">
                ...
                NLP, CV, ML and AI, which are implemented in our models being
                used to optimize business growth and product management. We can
                achieve this for you with the following services:
              </p>
            </div>
            <div>
              <ul className="domain-list">
