...
const FetchAllProducts = (setAllProducts, setProductLoader) => {
  ...
  products[0] = {
    ...
    'description': "A revolutionary ML-based personality assessment solution to bridge the gap between end users and target users using LinkedIn data using text data provided on their website",
    'image': "1_V7bMlFm3Y6fYnNwAkgjdAtW5XjSeliN",
    'overview': "Voltaire.ai joined hands with our team to develop a leading personality assessment tool, connecting end users and target users to efficiently deal each other. Offering a Machine Learning based system to detect ‘Myers Briggs’ personality types of people using text data provided on their LinkedIn profile, it would assist salespeople in their marketing campaigns.",
    'solution': "LinkedIn profiles were scraped via a custom scrapper, and transformer based was used to predict accurate personality types of users. Using information such as location, school, organization and their personality types were saved in a database. The users email was checked in the database and if the person was found, they displayed information of the targets personality along with recommendations on how to deal with them along with additional information about events in their cities, financial and Google news about the organization they work in are also displayed. If the email is not in the database, then program would ask for their LinkedIn profile links, scrape all the data, find the personality type and news and display the rest of data. Python was used as the backend language, mainly due to the ML module assisted with the waterfall methodology.",
    'the_challenge': "Our client approached us with the vision of a revolutionary personality assessment tool that would bridge the gap between end users and target users. Providing us with emails of users, our responsibility was to develop a system that bridges the gap between target users and end users.",
  ...
  products[1] ={
    ...
    description: "Detection and recognition of diverse vehicular license plates made possible through pattern recognition, image processing and Computer Vision showing through live video image ",
    overview: "Our fast growth team specializes in a variety of applications ranging from safety systems to collective areas, and from parking admission and traffic control to government organizations. Our team created a license plate recognition system that localized license plates given in the live video/image and then recognized the license plate number to match with the information saved in the database.",
    the_challenge: "Our client approached us with the vision of a license plate recognition model that targets the challenge of detecting and recognizing license plates of their citizens’ vehicles. The task proved a challenge due to the diversity of plate formats and non-uniform outdoor conditions such as fixed illumination, limited vehicle speed, designated routes and stationary backgrounds.",
    solution: "Our License recognition method aims at finding regions where the plate is located. This task is related to techniques such as pattern recognition, image processing and computer vision. HOG (Histogram of Oriented Gradients), a feature descriptor, is used to characterize objects through their shapes. HOG is the best choice in this case as the number plates are usually in rectangular basic shape. It is indeed important to note that the license plates do come in different shapes and sizes making it harder to detect them. In our solution, a license plate localization method based on an approach using HOG descriptors and a linear SVM classifier is used. Different HOG setups are evaluated aiming at identifying the specific configuration that best performs for (for example) Pakistani license plates.",
  ...
  products[4] = {
    ...
    description: "In the domain of Computer Forensics and Cybersecurity, detecting online child abuse using ML and NLP to keep social media platforms free from all sorts of hate speech           ",
    overview:"With a rapidly expanding social network and user base, and thus to efficiently keep up with user expectations, it is important to cater hate speech and online abuse. In the quest to make social media platforms free from any and all sorts of hate speech and online abuse, our team focuses to detect online child abuse on Twitter using NLP (Natural Language Processing). ",
    the_challenge:"Our dedicated team joined hands with CHAEF- Children’s Health And Education Fund, a non-government organization to build the solutions roadmap for their successful digital transformation aimed at protecting children online. Our framework meets Computer Forensics and Cybersecurity aims, which is all about making the internet safe. Developing an extensive NLP-based tool which would perform lexicon-based analysis of each piece of text to determine if it involves any sort of inappropriate content is a tough task, as children are more fragile and sensitive in terms of negative remarks. In order to make Twitter a better social media platform for children, efforts for child abuse detection are made, to promote better mental health for children of all ages.",
    solution:"Taking “sentiment analysis” as the basis of the project, we detected hate speech and abusive comments especially directed towards young boys and girls, and children on social media. NLP techniques and methods were used at the core for data cleaning and gathering purposes. Machine Learning based classification and Information Extractor Algorithms were incorporated to understand sentence structures and accuracy measurement. We used the NLTK word-to-vector model to generate word embeddings and word vectorization for detecting hate speech. This framework focused on detecting hate speech and abuse against children specifically.",
    createdAt:'2022-12-01T15:01:56.490+00:00',
    updatedAt:'2022-12-01T15:01:56.490+00:00'
  };
  products[5] = {
    ...
    description: "Our regression model was created to forecast the repayment rate of student loans based on boosted decision tree regression, whilst keeping students' data safe and secure",
    overview:"Our specialist team partnered with JND financial to develop a student loan prediction system for the Loan Lending company. Our developed model involved the detailed analysis made over the degree of the student, median household income of the city and state and involved several other key factors necessary to determine if lending the loan was risky or not.",
    the_challenge:"The key concept involves protecting the rights of individuals to decide how their personal information is used while ensuring that predictive models are based on representative data.",
    solution:"We use permutation feature importance to determine the most optimal features for training our models and providing best possible accuracy for our predictive model. We use a regression model in order to forecast repayment rates. We tested the logistic model and boosted the decision tree model to determine which model produced minimal error while training the model. Our regression model was created to predict the repayment rate based on boosted decision tree regression. ",
    createdAt:'2022-12-01T15:01:56.490+00:00',
    updatedAt:'2022-12-01T15:01:56.490+00:00'
  }
  products[6] = {
